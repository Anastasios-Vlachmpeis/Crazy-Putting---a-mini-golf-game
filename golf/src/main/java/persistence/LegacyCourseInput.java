...
public final class LegacyCourseInput {
    ...
    public static LegacyCourseInput fromFile(String filePath) throws Exception {
    ...
    public static LegacyCourseInput fromGui(String heightFormula, String[][] inputValuesGUI) {
        return new LegacyCourseInput(
            inputValuesGUI[0],
            inputValuesGUI[1],
            inputValuesGUI[2],
