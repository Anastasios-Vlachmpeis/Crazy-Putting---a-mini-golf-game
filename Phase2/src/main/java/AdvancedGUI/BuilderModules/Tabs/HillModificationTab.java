...
public class HillModificationTab extends BorderPane{
    ...
    public HillModificationTab(GolfCourse course, double[] preViewSize) {
        ...
        */
        ...
        Slider strengthSlider = new Slider(0, 2.5, 1);
        ...
        Slider widthSlider = new Slider(0.5, 10.0, 2.0); 
        ...
        //Mouse tracker for adding hills/valelys
            ...
            try {
                ...
                System.out.println("Error: Height and Width text fields must contain valid numbers.");
            }
        });
    }
